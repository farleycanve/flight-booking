...
func (a *AuthenticateAndPostServer) ensureUserExist(ctx context.Context, userId int64) error {
	var user types.User
...
func (a *AuthenticateAndPostServer) FollowUser(ctx context.Context, req *authen_and_post.FollowUserRequest) (*authen_and_post.FollowUserResponse, error) {
...
func (a *AuthenticateAndPostServer) UnfollowUser(ctx context.Context, req *authen_and_post.UnfollowUserRequest) (*authen_and_post.UnfollowUserResponse, error) {
	err := a.ensureUserExist(ctx, req.UserId)
	if err != nil {
...
func (a *AuthenticateAndPostServer) GetFollowerList(ctx context.Context, req *authen_and_post.GetFollowerListRequest) (*authen_and_post.GetFollowerListResponse, error) {
	err := a.ensureUserExist(ctx, req.UserId)
	if err != nil {
