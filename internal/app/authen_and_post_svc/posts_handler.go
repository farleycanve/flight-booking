...
import (
	...
	"github.com/EngineerProOrg/BE-K07/internal/pkg/types"
	"github.com/EngineerProOrg/BE-K07/pkg/types/proto/pb/authen_and_post"
)

func (a *AuthenticateAndPostServer) GetPost(ctx context.Context, in *authen_and_post.GetPostRequest) (*authen_and_post.GetPostResponse, error) {
...
func (a *AuthenticateAndPostServer) CreatePost(ctx context.Context, in *authen_and_post.CreatePostRequest) (*authen_and_post.CreatePostResponse, error) {
...
func (a *AuthenticateAndPostServer) DeletePost(ctx context.Context, in *authen_and_post.DeletePostRequest) (*authen_and_post.DeletePostResponse, error) {
...
// EditPost edit post
func (a *AuthenticateAndPostServer) EditPost(ctx context.Context, in *authen_and_post.EditPostRequest) (*authen_and_post.EditPostResponse, error) {
...
func (a *AuthenticateAndPostServer) CreatePostComment(ctx context.Context, in *authen_and_post.CreatePostCommentRequest) (*authen_and_post.CreatePostCommentResponse, error) {
...
// LikePost like post
func (a *AuthenticateAndPostServer) LikePost(ctx context.Context, in *authen_and_post.LikePostRequest) (*authen_and_post.LikePostResponse, error) {
